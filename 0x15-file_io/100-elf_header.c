...
/**
 * print_data - tp Prints the data of an ELF header.
...
/**
 * print_type - to Prints the type of an ELF header.
 * @e_type: ELF type.
 * @e_ident: the  pointer to an array containing the ELF class.
 */
 ...
 * @e_entry: to address of the ELF entry point.
 * @e_ident: the pointer to an array containing the ELF class.
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
